...
# Helper functions for retrieving data from session state
...
def calculate_strategy_current_value(strategy_legs, price_range, days_to_expiry, 
    ...
    """
    # This function would normally import from utils.py
    # For simplicity, we're including a copy here
